...
long long seek_run(size_t n, const int* arr, int x) {
...
//По BigO - это n^2; Лучший случай: O(n), Средний случай: O(n^2), Худший случай: O(n^2), Одинаковый случай: O(n^2)
template <typename A>
...
//n - размер массива; arr - массив;
//size_t - это беззнаковый целый тип для представления размера объекта в памяти
//По BigO - это n^2; Лучший случай: O(n log n), Средний случай: O(n log n), Худший случай: O(n^2), Одинаковый случай: O(n log n)
template <typename A>
...
//По BigO - это это log n; Лучший случай: O(n log n), Средний случай: O(n log n), Худший случай: O(n log n), Одинаковый случай: O(n log n)
...
//По BigO - это это n^2; Лучший случай: O(n log n), Средний случай: О(n^2), Худший случай: О(n^2), Одинаковый случай: О(n log n)
...
//arr - массив; low - индекс низжего элемента; high - индекс высшего элемента
//По BigO - это log n; Лучший случай: O(n log n), Средний случай: O(n log n), Худший случай: O(n log n), Одинаковый случай: O(n log n)
template <typename A>
